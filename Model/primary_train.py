...
Models = {
    'XGB':XGBClassifier(random_state=23333),
    'GBDT':GradientBoostingClassifier(random_state=23333),
    'RF':RandomForestClassifier(random_state=23333),
    'LR':LogisticRegression(random_state=23333),
    'LightGBM':lgb.LGBMClassifier(random_state=23333),
    'AdaBoost': AdaBoostClassifier(random_state=23333),
    'CatBoost':CatBoostClassifier(random_state=23333)
}
...
plt.savefig('bl_Train_ROC.png', dpi=330, bbox_inches='tight')
plt.show()  # 显示训练集ROC曲线
...
plt.legend(loc="lower right")
plt.savefig('bl_Test_ROC.png', dpi=330, bbox_inches='tight')
plt.show()   # Display
