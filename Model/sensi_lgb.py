...
#from sklearn.linear_model import LinearRegression, BayesianRidge, ridge_regression, LogisticRegressio
import pandas as pd
...
def calculate_metrics_for_splits(dataset, test_sizes):
    ...
    for ratio in test_sizes:
        ...
        model = lgb.LGBMClassifier(random_state=555,
    n_estimators=5978,
...
plt.title('LightGBM Sensitivity Analysis')
plt.grid(True)
...
# 保存图像
path = os.path.join(output_dir, "lgb_Sensitivity_AUROCC_F1_Brier_ACC.png")
